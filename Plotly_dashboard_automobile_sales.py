...
app.layout = html.Div([
    ...
    html.Div([
        ...
        html.Label("Select Statistics:", style={'font-size': 25}),
        dcc.Dropdown(
            id='dropdown-statistics',
            options=dropdown_options,
            placeholder='Select a report type',
            value='Select Statistics',
            style={'width': '50%', 'font-size': 20, 'textAlign': 'center'}
        )
    ]),
    html.Div(dcc.Dropdown(
            ...
            value="",
            style={'width': '50%', 'font-size': 20, 'textAlign': 'left'}
        )),
    html.Div([
...
# Returning the graphs for displaying recession data
        return [
